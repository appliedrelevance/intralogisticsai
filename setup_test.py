...
print("🚀 Testing setup wizard completion...")
...
if frappe.is_setup_complete():
    ...
    print(f"   - UOMs: {uoms}")
    print(f"   - Setup Complete: True")
    
else:
    print("🔧 Setup wizard not complete, running completion...")
    ...
    # Update the company with proper details
